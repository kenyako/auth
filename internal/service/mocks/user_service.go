...
func (_m *UserService) Create(ctx context.Context, data *model.UserCreate) (int64, error) {
...
func (_m *UserService) Update(ctx context.Context, data *model.UserUpdate) error {
	ret := _m.Called(ctx, data)
